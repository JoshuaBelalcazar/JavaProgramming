...
Create subclasses "ResidentialBuilding" and "CommercialBuilding" that add specific attributes like number of apartments for residential
and office space for commercial buildings. Implement a method to calculate the total rent for each subclass.
*/
...
class ResidentialBuilding extends Building {
    // Additional attributes for ResidentialBuilding
...
class CommercialBuilding extends Building {
    // Additional attributes for CommercialBuilding
